...
TiCLE Lite 상단에 아래 사진과 같이 장착되어 있습니다.
...
- I2C 및 I2S 등 다양한 제어를 위한 통신 기능 제공
...
- 총 16개의 5V, 4개의 3.3V의 안정적인 출력 제공
- 총 20개의 Ground Pin 제공
...
TiCLE Lite에는 상술한 세 보드 외에도 주변장치들이 존재합니다. 아래 사진과 같이 PixelLed Matrix, Ultrasonic, Servo Motor가 존재합니다.
...
아래 방법과 같이 VSCode 터미널을 연 뒤 아래 명령어를 통해 replx를 설치합니다.
...
<img src="pds/pip_install.png" style="width:70%;">

### replx 사용

우선, VSCode 상에서 작업할 위치에 폴더를 엽니다.

<img src="pds/open_folder.png" width="50%"/>

<br>

<img src="pds/select_folder.png" width="50%"/>
...
<img src="pds/replx_scan.png" width="75%"/>
...
<img src="pds/replx_register_env.png" width="75%" />
...
<img src="pds/replx_download.png" width="75%"/>
...
<img src="pds/replx_run.png" width="35%" />
